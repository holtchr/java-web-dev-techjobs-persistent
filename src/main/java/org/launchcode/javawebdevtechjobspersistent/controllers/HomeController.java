...
public class HomeController {
    ...
    public String processAddJobForm(@ModelAttribute @Valid Job newJob,
        ...
        //line below from suggested code on assignment #4 page, creates duplicates in job_skill join table
        //when not commented out, when commented out the application works fine
